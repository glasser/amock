...
public class WeakIdentityHashMap<K,V>
    ...
    private Action<V> callBackOnReferenceGarbageCollection;

    
    /**
     * Constructs a new, empty <tt>WeakIdentityHashMap</tt> with the
     * given initial capacity and the given load factor.
     * And a callback fired when object are garbage collected
     *
     ...
     */
    public WeakIdentityHashMap(int initialCapacity, float loadFactor, Action<V> action) {
        this(initialCapacity, loadFactor);
        this.callBackOnReferenceGarbageCollection = action;
    }
     ...
     * (0.75).
     */
    public WeakIdentityHashMap(Action<V> action) {
        this();
        this.callBackOnReferenceGarbageCollection = action;
    }
	...
	Entry<K,V> e;
        ...
        while ( (e = (Entry<K,V>) queue.poll()) != null) { // unchecked cast
            ...
            callBackOnReferenceGarbageCollection.action(e.value);
